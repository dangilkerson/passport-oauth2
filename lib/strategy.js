...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  var clientID = lookup(req.body, 'clientID') || options.clientID;
  var clientSecret = lookup(req.body, 'clientSecret') || options.clientSecret;

  req.session.passport.user = clientID;
  ...
  if (req.query && req.query.code) {
    ...
    oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL },
